	...
	<body lang="en">
		...
		<div id="main">
			...
			<div id="content">
				...
				<!-- masthead -->
		        <div id="masthead">
					<span class="head">Edit your project here</span><span class="subhead"></span>
	        	...
	        	<div id="page-content-full">
                    ...
                    {
						$t1=$row["Project_name"];
						$t2=$row["Project_description"];
						$t3=$row["Due"];
					}
                    ?>
                        <div id="login" class="animate form">
                            <form  action="edit_project_db.php" autocomplete="on" method="post"> 
                                <h1>Edit Project</h1> 
                                <p> 
                                    <label for="emailsignup"  >Project Topic *</label>
                                    <input id="emailsignup" name="name" required="required" type="text" value="<?php echo $t1;?>"/> 
                                </p>
								...
								<br><br>				
                                    ...
                                    <input id="emailsignup" name="due" required="required" type="text" value="<?php echo $t3;?>"/>
                                </p>						
