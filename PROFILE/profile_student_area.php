				...
				<div class="pic">
					...
					<div class="clearfix"></div>
						...
						?>							
												...
												<h1><legend>My Interests</legend></h1></br></br>
                               <textarea rows="2" cols="50" type="text"  name="interest1" ><?php $vtb1 = $result2['interest1']; echo ''.$vtb1.''; ?></textarea></br></br>  
							    <textarea rows="2" cols="50" type="text"  name="interest2" ><?php $vtb2 = $result2['interest2']; echo ''.$vtb2.''; ?></textarea>  </br></br>
								 <textarea rows="2" cols="50" type="text"  name="interest3" ><?php $vtb3 = $result2['interest3']; echo ''.$vtb3.''; ?> </textarea>  </br></br>
								  <textarea rows="2" cols="50" type="text"  name="interest4"><?php $vtb4 = $result2['interest4']; echo ''.$vtb4.''; ?> </textarea>  </br></br>
								   <textarea rows="2" cols="50" type="text"  name="interest5" > <?php $vtb5 = $result2['interest5']; echo ''.$vtb5.''; ?></textarea></br>  
