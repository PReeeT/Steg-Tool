		...
		<div id="main">
			...
			<div id="content">
	        	...
	        	<div id="page-content-full">
					...
					?>                        
                      <form  action="student_recover_password_msg1.php" autocomplete="on" method="post" name="firstform" ">
                      <?php  } ?>
                                ...
                                <p> 
                                    <label for="password" class="youpasswd" data-icon="p"> Enter your registered email ID </label>
