                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
							...
							<?php 
								...
								//apc_store('rec_username' , $username);
								//apc_store('rec_email' , $email);
...
$email = $rec_email;
  ...
  //$msg_1 =  "An email has been sent to " . $_SESSION['email'] . "with an activation key. Please check your mail to complete registration.";

##Send activation Email

$to      = $email;

$subject = " researchintern.net Recover Password";

$message = "Welcome to our website!\r\r You can recover password by clicking the following link:\rhttp://www.researchintern.net/student_recover_password_msg1.php\r\rIf this is an error, ignore this email.\r\rRegards,\ ResearchIntern Team";

$headers = 'From: noreply@researchintern' . "\r\n" .

    'Reply-To: noreply@researchintern.net' . "\r\n" .

    'X-Mailer: PHP/' . phpversion();

mail($to, $subject, $message, $headers);
header("Location: student_recover_password_step2.php");

} else {

header("Location: student_recover_password_step1.php");
}
?>
                               ...
                               <center> <h2>Password Recovery Phase- I</h2></center>

                      
								<br/><br/>
                                <p> 
                                    A Mail has been sent to your registered e-mail ID with a password recovery link. Please click the link to recover your password.
									Check for the mail in inbox also in spam/junk.
                                </p>
