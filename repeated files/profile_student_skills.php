			...
			<div id="content">
				...
				<div class="pic">
					...
					<div class="socialMediaLinks">
						<a href="http://twitter.com/nish-ingenious" rel="me" target="_blank"><img src="img/twitter.png" alt="@nish-ingenious" /></a>
						<a href="http://facebook.com/nish.sizzles" rel="me" target="_blank"><img src="img/facebook.png" /></a>
					</div>
					<div class="sep"></div>
...
<br><br>
    ...
    <?php
                                                        ...
                                                        $name = $_SESSION['name'];
                                                        $sql1="Select * from skills where Name='$name'";
                                                        $data1 = mysql_query($sql1);
                                                        $result1 = mysql_fetch_array($data1);
         ?>
         <div class="wrapper">
<form method="post" action="skills_process.php">   
		<label for="username" class="uname" data-con="u">Add Skill </label> 
                <br>
                <input type="text" name="textbox1" id='sty' class="box" value="<?php $sk1= $result1['Skill_1']; echo ''.$sk1.'';  ?>" />
                <br>
                <hr>
                <br>
                <br>
                <label for="username" class="uname" data-con="u"> Rate </label>
                <br>
                <select name="list1" class="boxx" id="sty" selected="<?php $r1= $result1['Rate_1']; echo ''.$r1.''; ?> ">
                        <option value="1" <?=$result1['Rate_1'] == '1' ? ' selected="selected' : '1';?>">1</option>
                        <option value="2" <?=$result1['Rate_1'] == '2' ? ' selected="selected' : '2';?>">2</option>
                        <option value="3" <?=$result1['Rate_1'] == '3' ? ' selected="selected' : '3';?>">3</option>
                        <option value="4" <?=$result1['Rate_1'] == '4' ? ' selected="selected' : '4';?>">4</option>
                        <option value="5" <?=$result1['Rate_1'] == '5' ? ' selected="selected' : '5';?>">5</option>
                        <option value="6" <?=$result1['Rate_1'] == '6' ? ' selected="selected' : '6';?>">6</option>
                        <option value="7" <?=$result1['Rate_1'] == '7' ? ' selected="selected' : '7';?>">7</option>
                        <option value="8" <?=$result1['Rate_1'] == '8' ? ' selected="selected' : '8';?>">8</option>
                        <option value="9" <?=$result1['Rate_1'] == '9' ? ' selected="selected' : '9';?>">9</option>
                        <option value="10" <?=$result1['Rate_1'] == '10' ? ' selected="selected' : '10';?>">10</option>
                </select>
                <br><br><br><br>
                <label for="username" class="uname" data-con="u">Add Skill </label> 
                <br>
                <input type="text" name="textbox2" id='sty' class="box" value="<?php $sk2 = $result1['Skill_2']; echo ''.$sk2.''; ?>">
                <br>
                <hr>
                <br>
                <label for="username" class="uname" data-con="u"> Rate </label>
                <br>
                <select name="list2" class="boxx" id="sty" value="<?php $r2 = $result1['Rate_2']; echo ''.$r2.''; ?>">
                        <option value="1" <?=$result1['Rate_2'] == '1' ? ' selected="selected' : '1';?>">1</option>
                        <option value="2" <?=$result1['Rate_2'] == '2' ? ' selected="selected' : '2';?>">2</option>
                        <option value="3" <?=$result1['Rate_2'] == '3' ? ' selected="selected' : '3';?>">3</option>
                        <option value="4" <?=$result1['Rate_2'] == '4' ? ' selected="selected' : '4';?>">4</option>
                        <option value="5" <?=$result1['Rate_2'] == '5' ? ' selected="selected' : '5';?>">5</option>
                        <option value="6" <?=$result1['Rate_2'] == '6' ? ' selected="selected' : '6';?>">6</option>
                        <option value="7" <?=$result1['Rate_2'] == '7' ? ' selected="selected' : '7';?>">7</option>
                        <option value="8" <?=$result1['Rate_2'] == '8' ? ' selected="selected' : '8';?>">8</option>
                        <option value="9" <?=$result1['Rate_2'] == '9' ? ' selected="selected' : '9';?>">9</option>
                        <option value="10" <?=$result1['Rate_2'] == '10' ? ' selected="selected' : '10';?>">10</option>
                </select>
                <br><br><br><br>
                <label for="username" class="uname" data-con="u">Add Skill </label> 
                <br>
                <input type="text" name="textbox3" id='sty' class="box" value="<?php $sk3 = $result1['Skill_3']; echo ''.$sk3.''; ?>">
                <br>
                <hr>
                <br>
                <label for="username" class="uname" data-con="u"> Rate </label>
                <br>
                <select name="list3" class="boxx" id="sty" value="<?php $r3 = $result1['Rate_3']; echo ''.$r3.''; ?>">
                        <option value="1" <?=$result1['Rate_3'] == '1' ? ' selected="selected' : '1';?>">1</option>
                        <option value="2" <?=$result1['Rate_3'] == '2' ? ' selected="selected' : '2';?>">2</option>
                        <option value="3" <?=$result1['Rate_3'] == '3' ? ' selected="selected' : '3';?>">3</option>
                        <option value="4" <?=$result1['Rate_3'] == '4' ? ' selected="selected' : '4';?>">4</option>
                        <option value="5" <?=$result1['Rate_3'] == '5' ? ' selected="selected' : '5';?>">5</option>
                        <option value="6" <?=$result1['Rate_3'] == '6' ? ' selected="selected' : '6';?>">6</option>
                        <option value="7" <?=$result1['Rate_3'] == '7' ? ' selected="selected' : '7';?>">7</option>
                        <option value="8" <?=$result1['Rate_3'] == '8' ? ' selected="selected' : '8';?>">8</option>
                        <option value="9" <?=$result1['Rate_3'] == '9' ? ' selected="selected' : '9';?>">9</option>
                        <option value="10" <?=$result1['Rate_3'] == '10' ? ' selected="selected' : '10';?>">10</option>
                </select>
                <br><br><br><br>
                <label for="username" class="uname" data-con="u">Add Skill </label> 
                <br>
                <input type="text" name="textbox4" id='sty' class="box" value="<?php $sk4 = $result1['Skill_4']; echo ''.$sk4.''; ?>">
                <br>
                <hr>
                <br>
                <label for="username" class="uname" data-con="u"> Rate </label>
                <br>
                <select name="list4" class="boxx" id="sty" value="<?php $r4 = $result1['Rate_4']; echo ''.$r4.''; ?>">
                        <option value="1" <?=$result1['Rate_4'] == '1' ? ' selected="selected' : '1';?>">1</option>
                        <option value="2" <?=$result1['Rate_4'] == '2' ? ' selected="selected' : '2';?>">2</option>
                        <option value="3" <?=$result1['Rate_4'] == '3' ? ' selected="selected' : '3';?>">3</option>
                        <option value="4" <?=$result1['Rate_4'] == '4' ? ' selected="selected' : '4';?>">4</option>
                        <option value="5" <?=$result1['Rate_4'] == '5' ? ' selected="selected' : '5';?>">5</option>
                        <option value="6" <?=$result1['Rate_4'] == '6' ? ' selected="selected' : '6';?>">6</option>
                        <option value="7" <?=$result1['Rate_4'] == '7' ? ' selected="selected' : '7';?>">7</option>
                        <option value="8" <?=$result1['Rate_4'] == '8' ? ' selected="selected' : '8';?>">8</option>
                        <option value="9" <?=$result1['Rate_4'] == '9' ? ' selected="selected' : '9';?>">9</option>
                        <option value="10" <?=$result1['Rate_4'] == '10' ? ' selected="selected' : '10';?>">10</option>
                </select>
                <br><br><br><br>
                <label for="username" class="uname" data-con="u">Add Skill </label> 
                <br>
                <input type="text5" name="textbox5" id='sty' class="box" value="<?php $sk5 = $result1['Skill_5']; echo ''.$sk5.''; ?>">
                <br>
                <hr>
                <br>
                <label for="username" class="uname" data-con="u"> Rate </label>
                <br> 
                <select name="list" class="boxx" id="sty" value="<?php $r5 = $result1['Rate_5']; echo ''.$r5.''; ?>">
                        <option value="1" <?=$result1['Rate_5'] == '1' ? ' selected="selected' : '1';?>">1</option>
                        <option value="2" <?=$result1['Rate_5'] == '2' ? ' selected="selected' : '2';?>">2</option>
                        <option value="3" <?=$result1['Rate_5'] == '3' ? ' selected="selected' : '3';?>">3</option>
                        <option value="4" <?=$result1['Rate_5'] == '4' ? ' selected="selected' : '4';?>">4</option>
                        <option value="5" <?=$result1['Rate_5'] == '5' ? ' selected="selected' : '5';?>">5</option>
                        <option value="6" <?=$result1['Rate_5'] == '6' ? ' selected="selected' : '6';?>">6</option>
                        <option value="7" <?=$result1['Rate_5'] == '7' ? ' selected="selected' : '7';?>">7</option>
                        <option value="8" <?=$result1['Rate_5'] == '8' ? ' selected="selected' : '8';?>">8</option>
                        <option value="9" <?=$result1['Rate_5'] == '9' ? ' selected="selected' : '9';?>">9</option>
                        <option value="10" <?=$result1['Rate_5'] == '10' ? ' selected="selected' : '10';?>">10</option>
                </select>
                <br><br><br><br>
